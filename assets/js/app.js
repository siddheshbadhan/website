...
<div class="collapse navbar-collapse " id="navbarSupportedContent">
  <ul class="navbar-nav ml-auto" id = "navbar-content">
   ...
   <li class="nav-item nav-item-hover"><a class="nav-link" href="https://drive.google.com/file/d/1T_n-b_2LuYFRofXn3sneDYZ5DKRrETfY/view?usp=sharing" target="_blank">Resume</a></li>
   <li class="nav-item">
...
<footer class="footer sticky-bottom"  style="background-color:#2b2a2a;">
  <div class="p-4">
    <div class="container-fluid quote-container">
      ...
      <p class="tag" >"What makes you weird, makes you unique and therefore makes you stand out." - Dan Schawbel</p>
    </div>
    ...
    <a class="social-button linkedin" href="https://www.linkedin.com/in/siddheshbadhan/" target="_blank" >
  ...
  $(window).scroll(function () {
    ...
    if ($(window).scrollTop() < $(window).height()) {
      ...
      if (
        ...
        $("#btnScrollToTop").css("background-color", "#2272FF");
      } else {
        $("#btnScrollToTop").css("background-color", "#2272FF");
      }
    }
